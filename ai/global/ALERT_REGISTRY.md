...
alert=codex_sqlite_wal_critical;owner=codex-local-maintenance;owner_project=disk-usage-monitor;source_service=codex-sqlite-wal-maintenance.service;source_timer=codex-sqlite-wal-maintenance.timer;transport=Telegram_local_optional_existing_helper;events=logs_2.sqlite-wal_ge_20GiB;severity=critical;actionability=codex_investigate;false_positive_risk=low;cooldown=21600s;secrets=no_hardcoded_uses_existing_telegram_env
...
project=disk-usage-monitor;alerts=disk_usage_canonical,disk_usage_ok_digest,codex_sqlite_wal_critical
