...
alert=disk_usage_delta;owner=disk-usage-monitor;owner_project=disk-usage-monitor;source_service=disk-usage-monitor.service;transport=Telegram+Kuma documented in /home/daniele/disk_usage_monitor;events=free_space_delta>=500MiB cooldown_6h_per_disk_direction;severity=warning;actionability=codex_investigate;false_positive_risk=medium
