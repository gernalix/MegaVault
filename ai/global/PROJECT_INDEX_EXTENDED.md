...
SOURCE=PROJECT_INDEX+Fedora_live_revalidation_2026-07-14+activity_593184+activity_471852+activity_471853+activity_846271+activity_583921+activity_684219+activity_826417
...
project=fedora-system-monitor;repo=/home/daniele/MegaVault/projects/fedora-system-monitor;remote=https://github.com/gernalix/fedora-system-monitor.git;branch=codex/471853-fedora-system-monitor;version=1.1.1;runtime=/usr/local/libexec/fedora-system-monitor;config=/etc/fedora-system-monitor;data=/var/lib/fedora-system-monitor;services=events+lifecycle+collector_templates+optional_prometheus_disabled;timers=fast+hourly+daily+weekly;path=software;features=dashboard+timeline+trends+service_history+prometheus_optional;status=installed+enabled+tested;activity=471853
project=fedora-diagnostics;repo=/home/daniele/projects/fedora-diagnostics;remote=UNKNOWN;branch=local-only;version=1.0.0;runtime=/usr/local/lib/fedora-diagnostics;cli=/usr/local/bin/fedora-diagnostics;services=prometheus+prometheus-node-exporter+existing_custom_exporter_dependency;timers=none;status=installed+enabled+functional+fault_tested;activity=826417
