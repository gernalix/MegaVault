...
SOURCE=systemctl_live_2026-07-30+HOST_PROFILE+activity_482731+activity_418732+activity_638214+activity_847263+activity_593184+activity_471852+activity_471853+activity_583921+activity_684219+activity_638417+activity_846219+activity_826417+activity_592184+activity_731904+activity_948315+activity_582941+activity_641827+activity_573814+activity_614283+activity_731842
...
command=fedora-diagnostics;mode=manual_on_demand;path=/usr/local/bin/fedora-diagnostics;version=1.2.0;fan_analysis=yes;activity=826417+614283+948315
...
audit=fedora-system-monitor_1.2.0;historical=yes;composite_memory_pressure+detailed_SMART+battery+Btrfs;collectors=minute+daily_real_ok;tests=100_PASS;selftest=18_PASS;activity=962417
...
timer=snapper-timeline.timer;scope=system;state=enabled+active;purpose=periodic_root_Btrfs_snapshots;activity=962417
timer=snapper-cleanup.timer;scope=system;state=enabled+active;purpose=snapshot_retention_cleanup;activity=962417
timer=btrfs-scrub.timer;scope=system;state=enabled+active;calendar=monthly;purpose=read_only_root_scrub;activity=962417
timer=fwupd-refresh.timer;scope=system;state=enabled+active;purpose=LVFS_metadata_refresh_without_automatic_firmware_install;activity=962417
timer=raid-check.timer;scope=system;state=disabled+inactive;reason=no_MD_arrays;activity=962417
