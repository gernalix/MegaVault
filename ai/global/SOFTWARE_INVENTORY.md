# SOFTWARE_INVENTORY
VERSION=1
STATUS=LEGACY_MINT_SNAPSHOT_CURRENT_WINDOWS_UNKNOWN
MODE=codex_first
FORMAT=ultracompressed
SOURCE=command_versions_live_2026-06-08+dpkg+flatpak+HOST_PROFILE;current_windows_not_scanned_prompt_483920
PROTOCOL=../MEGAVAULT_PROTOCOL.md
HOST_PROFILE=HOST_PROFILE.md
HUMAN=../../human/global/SOFTWARE_INVENTORY.md

CURRENT_WINDOWS_SOFTWARE:
host=ThinkPad_P14s_Gen_5_AMD
os=Windows_11_Pro
codex_desktop=target_current;version=UNKNOWN
git=UNKNOWN
gh=UNKNOWN
python=UNKNOWN
node=UNKNOWN
java=UNKNOWN
android_studio=UNKNOWN
android_sdk_path=UNKNOWN
adb_path=UNKNOWN
rg=UNKNOWN
powershell=default_shell;version=UNKNOWN
wsl=UNKNOWN
docker=UNKNOWN
rule=verify_live_before_using_tool_paths_or_versions

LEGACY_MINT_RUNTIME_TOOLS:
...
LEGACY_MINT_BACKUP_STORAGE_TOOLS:
...
LEGACY_MINT_NETWORK_REMOTE_TOOLS:
...
OPEN:
open=Current_Windows_tool_inventory_UNKNOWN_not_scanned_prompt_483920
