...
app=ActivityWatch;version=v0.13.2;install=official_ActivityWatch_GitHub_linux_x86_64_zip_user_flat;path=/home/daniele/.local/opt/activitywatch;dashboard=http://127.0.0.1:5600;desktop=none;status=PENDING_WAYLAND_WATCHERS
...
wayland=official_aw-watcher-window_Linux_X11_only;standard_aw-qt_watchers_tested_fail_on_GNOME_Wayland_X11_auth;third_party_wayland_watcher_not_kept
runtime=activitywatch.service_only;exec=/home/daniele/.local/opt/activitywatch/aw-qt_--no-gui_--autostart-modules_aw-server;server=127.0.0.1:5600;extra_runtime_layers=none;linger_not_required
validation=systemd_verify_PASS+enabled_active+API_PASS+dashboard_http_200+SQLite_integrity_ok+main_SIGKILL_restart_PASS+duplicates_absent+extra_port_absent;AFK=PENDING_UNSUPPORTED_IN_CURRENT_STANDARD_WAYLAND;window_events=PENDING_UNSUPPORTED_IN_CURRENT_STANDARD_WAYLAND
