...
personalhub_android_emulator=PersonalHub:tools/android_target_preflight.py;first_command=python3_tools/android_target_preflight.py_start;canonical_AVD=Pixel_8a;profile=pixel_8a;API36_google_apis_x86_64_rev7;1080x2400@420dpi;coordinate_bounds=(0,0)..(1079,2399);center=(540,1200);canonical_target_serial=resolve_live_emulator-*;helper_resolves_SDK+cold_boot_no_snapshots+boot_completed;launch_requires_current_GNOME_DISPLAY|WAYLAND_DISPLAY|XAUTHORITY;fallback_TCL_then_Pixel_only_when_blocked
personalhub_android_keystore=AndroidKeyStore_requires_live_Android_for_acceptance;Robolectric/host_provider_absence_is_expected_environment_limit;use_canonical_Pixel_8a_emulator_or_physical_device;host_tests_may_bypass_only_keystore_side_effect_via_explicit_test_hook
