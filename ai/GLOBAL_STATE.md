...
project=fedora-system-monitor;repo=/home/daniele/projects/fedora-system-monitor;runtime=/usr/local/libexec/fedora-system-monitor;config=/etc/fedora-system-monitor;data=/var/lib/fedora-system-monitor;status=installed+enabled+tested;version=1.3.1;activity=482731
...
project=fedora-t7-backup;repo=/home/daniele/projects/fedora-t7-backup;runtime=/usr/local/libexec/t7-restic-lifecycle;repository=/mnt/T7_BACKUP/restic-fedora;status=installed+backup+maintenance+restore+failsafe_tested;commit=99526e152e8de33527e32664b947c91415b59585;activity=684219
...
project=vm_oracle;repo=/home/daniele/projects/vm_oracle;runtime=ubuntu@150.230.148.128;status=PASS_CON_WARNING+apt_0+snap_0+venv_0+pip_check_PASS+services_PASS+reboot_complete+ssh_helper_verified+single_trunk;version=2026.08.01.1;commit=53c06b0;activity=731842+816429
