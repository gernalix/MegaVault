# GLOBAL_STATE
VERSION=1
STATUS=AUTHORITATIVE_CURRENT_CROSS_PROJECT
FORMAT=ultracompressed
UPDATED=2026-07-18
SOURCE=HOST_PROFILE+live_revalidations_through_2026-07-15
...
project=fedora-system-monitor;repo=/home/daniele/MegaVault/projects/fedora-system-monitor;runtime=/usr/local/libexec/fedora-system-monitor;config=/etc/fedora-system-monitor;data=/var/lib/fedora-system-monitor;status=installed+enabled+tested;version=1.1.1;activity=471853
