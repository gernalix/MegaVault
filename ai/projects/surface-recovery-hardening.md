...
ARCH:
transfer_logic=/home/daniele/transfer_vecchio_disco_adaptive_throttle_service.sh -> /home/daniele/transfer_vecchio_disco_phase2_limited.sh -> sudo -> rsync --append-verify; throttle child=/home/daniele/transfer_vecchio_disco_adaptive_throttle.sh
...
support_user=transfer-vecchio-disco-adaptive-throttle.service(enabled):manual transfer supervisor; starts phase2 rsync after mount preflight, then runs adaptive renice/ionice helper while rsync is alive
manual_cmd=rsync-transfer-start:/home/daniele/.local/bin/rsync-transfer-start verifies real unit+mounts, prints status before/after, starts transfer-vecchio-disco-adaptive-throttle.service only
manual_status=rsync-transfer-status:/home/daniele/.local/bin/rsync-transfer-status prints final_state RUNNING/WAITING/FAILED/STALE, systemd state, MainPID, target rsync process, throughput/stale reason
...
start=systemctl --user start transfer-vecchio-disco-adaptive-throttle.service; ExecStart=/home/daniele/transfer_vecchio_disco_adaptive_throttle_service.sh starts the real phase2 launcher only after source/dest preflight and refuses duplicate target rsync
...
ops_cmd=rsync-transfer-start verifies transfer-vecchio-disco-adaptive-throttle.service and source/dest mounts; prints before/after rsync-transfer-status; systemctl --user start does not create duplicate rsync workers because the supervisor checks target cmdline first
INV:
...
UnitThrottle=/home/daniele/.config/systemd/user/transfer-vecchio-disco-adaptive-throttle.service ExecStart=/home/daniele/transfer_vecchio_disco_adaptive_throttle_service.sh Restart=on-failure enabled
UnitWrapper=/home/daniele/transfer_vecchio_disco_adaptive_throttle_service.sh supervises phase2 launcher and throttle helper; unit active/running is expected to coincide with live target rsync, otherwise state is FAILED/WAITING not OK
ThrottleHelper=/home/daniele/transfer_vecchio_disco_adaptive_throttle.sh renice/ionice/bw profile control only
ManualStart=/home/daniele/.local/bin/rsync-transfer-start
ManualStatus=/home/daniele/.local/bin/rsync-transfer-status
Logs=/home/daniele/transfer_vecchio_disco_phase2.log,/home/daniele/transfer_vecchio_disco_phase2_warnings_errors.log,/home/daniele/transfer_vecchio_disco_service.log,/home/daniele/rsync_uptime_kuma_push.log,/home/daniele/transfer_usb_io_watchdog.log,/home/daniele/transfer_vecchio_disco_adaptive_throttle.log
State=/home/daniele/transfer_vecchio_disco_service_state.env,/home/daniele/transfer_vecchio_disco_phase2_status.env,/home/daniele/transfer_vecchio_disco_phase2_rsync.pid,/home/daniele/transfer_vecchio_disco_phase2_script.pid,/home/daniele/.rsync_uptime_kuma_push.state
...
issue=2026-06-10 unit transfer-vecchio-disco-adaptive-throttle.service was active/running but only ran the throttle loop; no target rsync existed, and phase2 source detection only accepted /dev/mapper/dm-0
cause=throttle helper does not launch rsync; source BitLocker was not mounted after reboot; phase2 launcher did not recognize /dev/mapper/source_bitlocker; dest preflight initially saw systemd-1 autofs before real /dev/sdc1
fix=2026-06-10 ExecStart now uses transfer_vecchio_disco_adaptive_throttle_service.sh supervisor; source detection accepts source_bitlocker and legacy bitlk mapper; mount preflight ignores autofs wrapper; source opened/mounted readonly and rsync started
RISK:
...
test_2026-06-10=systemctl --user status transfer-vecchio-disco-adaptive-throttle.service active/running MainPID=1108885; pgrep target rsync pids=1108990,1108995; rsync-transfer-status final_state=RUNNING metrics_status=live; journal shows RUNNING rsync pids and throttle renice/ionice
ROAD:
