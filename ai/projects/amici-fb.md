...
entry=UNKNOWN
ui=UNKNOWN
core=_shared/__init__.py,_shared/telegram_notify.py,amici-fb.service,amici-fb.timer,amici_fb.py
...
flow=amici-fb.service:10:ExecStart=/home/daniele/codex-workspace/scripts/amici_fb/.venv/bin/python -u -X faulthandler /home/daniele/codex-workspace/scripts/amici_fb/amici_fb_task_runner.py --headless
INV:
...
backup=amici-fb.service:2:Description=Snapshot amici Facebook (Playwright) + diff + SQLite + Telegram; amici_fb.service:2:Description=Snapshot amici Facebook + diff + SQLite + Telegram
migration=UNKNOWN
...
cmd=UNKNOWN
DATA:
db=amici-fb.service:2:Description=Snapshot amici Facebook (Playwright) + diff + SQLite + Telegram; amici_fb.service:2:Description=Snapshot amici Facebook + diff + SQLite + Telegram
