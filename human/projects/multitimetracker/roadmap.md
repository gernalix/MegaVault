...
- Priorita immediata: portare selettivamente su `master` v534 solo i pezzi sicuri dal backup v489 `backup/v489-play-store-work-20260622-093346`: workflow, release signing wiring, privacy policy, Data Safety, store listing, asset checklist, release notes e checklist. Aggiornare ogni baseline da 489 a 534 e rieseguire release gates.
- Play Store readiness reale dopo recupero #947263: circa 58 percento su master v534. PASS: codice/base moderna recuperata, compile/test/assembleDebug, versioning 534. FAIL/NEEDS: Play docs non ancora su master, signing release non riverificato su v534, privacy URL, Data Safety finale, store assets, tester list, Play Console.
