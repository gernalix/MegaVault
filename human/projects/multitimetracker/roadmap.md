...
- Play Store `#684219`: release build, upload keystore locale, APK/AAB firmati, copy-paste pack, closed testing steps e release notes sono PASS; prima del closed testing restano URL privacy pubblico, dati publisher/contact, Data Safety finale, target audience/content rating/category, asset Play, tester list e accettazione Play Console.
