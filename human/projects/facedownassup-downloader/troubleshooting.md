...
./fda_downloader.sh test 'https://members.facedownassup.com/gallery.php?id=173'
```
...
```bash
FDA_SLEEP_REQUESTS=0 ./fda_downloader.sh test 'https://members.facedownassup.com/gallery.php?id=173'
```

Use strict mode to fail instead of accepting skipped fragments:

```bash
FDA_ABORT_ON_UNAVAILABLE=1 ./fda_downloader.sh test 'https://members.facedownassup.com/gallery.php?id=173'
```
