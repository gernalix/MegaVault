...
- 2026-06-21: `#394827` porta la versione a 32 e introduce release signing permanente: Gradle firma la variant release con keystore SuperContacts quando i secret sono disponibili; gli script finali copiano APK release numerati invece di APK debug.
