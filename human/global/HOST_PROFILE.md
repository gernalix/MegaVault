...
Aggiornato: 2026-07-18. Autorita' operativa: [HOST_PROFILE AI](../../ai/global/HOST_PROFILE.md).

## Host corrente

- Macchina primaria: Lenovo ThinkPad P14s Gen 5 AMD, host `fedora`.
- Sistema: Fedora Linux 44 Workstation, kernel `7.1.3-201.fc44.x86_64`, architettura x86-64.
...
- Monitor host: Fedora System Monitor 1.2.0 installato, abilitato e verificato con database SQLite locale e cinque Push Monitor Kuma.
...
- Root e home: Btrfs su volume LUKS Kioxia NVMe da circa 951 GiB; `nodiscard`, fstrim settimanale, scrub mensile e snapshot Snapper del solo root sono attivi.
