...
Fedora System Monitor e' verificato come sender Kuma sul nuovo host. Usa cinque monitor: Fedora Host (ID 39), Storage (40), Network (41), Services (42) e Software (43). Heartbeat reali, un `DOWN` simulato e la recovery `UP` sono stati ricevuti. Deduplica, isteresi, cooldown e aggregazione impediscono notifiche ripetute.
