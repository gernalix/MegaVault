...
| `home-backup-kuma-push.service` | user | /home/daniele/backup_docs | inattivo | `home-backup-kuma-push.timer` | `/home/daniele/home_backup_kuma_push.sh` | result=success; #618903 last push `kuma_backup_push.json` up/warning ABORTED_SAFE |
| `home-backup-retention-kuma-push.service` | user | /home/daniele/backup_docs | inattivo | `home-backup-retention-kuma-push.timer` | `/home/daniele/home_backup_kuma_push.sh` | result=success; #618903 separate state `kuma_retention_push.json` |
| `home-incremental-backup.service` | user | /home/daniele/backup_docs | inattivo | `home-incremental-backup.timer` | `/home/daniele/home_incremental_backup.sh` | result=success after reset-failed; last real run was ABORTED_SAFE load guard |
